...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/aarch64-linux-gnu/qt5/QtCore/5.12.8"
        "${_qt5Core_install_prefix}/include/aarch64-linux-gnu/qt5/QtCore/5.12.8/QtCore"
    )
    ...
    macro(_populate_Core_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Core_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Core_check_file_exists(${imported_location})
