...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5Widgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Widgets_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5Widgets_VERSION_STRING 5.12.8)
...
macro(_populate_Widgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Widgets_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(_Qt5Widgets_OWN_INCLUDE_DIRS "${_qt5Widgets_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5Widgets_install_prefix}/include/aarch64-linux-gnu/qt5/QtWidgets")
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/aarch64-linux-gnu/qt5/QtWidgets/5.12.8"
        "${_qt5Widgets_install_prefix}/include/aarch64-linux-gnu/qt5/QtWidgets/5.12.8/QtWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5Widgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5Widgets_FIND_VERSION_EXACT}
    ...
    _populate_Widgets_target_properties(RELEASE "libQt5Widgets.so.5.12.8" "" )
    ...
    macro(_populate_Widgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Widgets_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Widgets_check_file_exists(${imported_location})
