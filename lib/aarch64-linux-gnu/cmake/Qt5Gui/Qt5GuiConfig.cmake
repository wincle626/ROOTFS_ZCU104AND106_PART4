...
if (NOT TARGET Qt5::Gui)
    ...
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/aarch64-linux-gnu/qt5/QtGui/5.12.8"
        "${_qt5Gui_install_prefix}/include/aarch64-linux-gnu/qt5/QtGui/5.12.8/QtGui"
    )
    ...
    macro(_populate_Gui_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Gui_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Gui_check_file_exists(${imported_location})
