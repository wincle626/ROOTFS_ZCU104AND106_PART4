...
get_filename_component(_realOrig "/usr/lib/aarch64-linux-gnu/cmake/Qt5Network" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Network_install_prefix "/usr/lib/aarch64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5Network_VERSION_STRING 5.12.8)
...
macro(_populate_Network_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Network_install_prefix}/lib/aarch64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Network)
    ...
    set(_Qt5Network_OWN_INCLUDE_DIRS "${_qt5Network_install_prefix}/include/aarch64-linux-gnu/qt5/" "${_qt5Network_install_prefix}/include/aarch64-linux-gnu/qt5/QtNetwork")
    set(Qt5Network_PRIVATE_INCLUDE_DIRS
        "${_qt5Network_install_prefix}/include/aarch64-linux-gnu/qt5/QtNetwork/5.12.8"
        "${_qt5Network_install_prefix}/include/aarch64-linux-gnu/qt5/QtNetwork/5.12.8/QtNetwork"
    )
    ...
    foreach(_module_dep ${_Qt5Network_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.8 ${_Qt5Network_FIND_VERSION_EXACT}
    ...
    _populate_Network_target_properties(RELEASE "libQt5Network.so.5.12.8" "" )
    ...
    macro(_populate_Network_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Network_install_prefix}/lib/aarch64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Network_check_file_exists(${imported_location})
